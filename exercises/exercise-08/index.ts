...
function requestUsers(callback: (response: UsersApiResponse<User[]>) => void) {
    callback({
        status: 'success',
        data: users
    });
...
function requestCurrentServerTime(callback: (response:  UsersApiResponse<number>) => void) {
    callback({
        status: 'success',
        data: Date.now()
    });
...
function requestCoffeeMachineQueueLength(callback: (response: UsersApiResponse<any>) => void) {
    callback({
        status: 'error',
